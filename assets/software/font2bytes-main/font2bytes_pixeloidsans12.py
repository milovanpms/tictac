...
# Configuration
filename = 'PixeloidSans12'           # <----- select new font name
fontname = 'PixeloidSans.ttf'         # <----- specify the font you intend to use. Place any font into the fonts folder
height = 16                           # <----- new font height
default_width = 9                    # <----- default font width

# Special widths for larger or thinner characters
special_widths = {
    32: 5,    # 'space' (réduit de 8 à 5)
    39: 5,    # "'" (réduit de 8 à 5)
    77: 12,   # 'M' (réduit de 16 à 12)
    78: 12,   # 'N' (réduit de 16 à 12)
    87: 12,   # 'W' (réduit de 16 à 12)
    102: 6,   # 'f' (réduit de 8 à 6)
    105: 4,   # 'i' (réduit de 6 à 4)
    106: 6,   # 'j' (réduit de 8 à 6)
    108: 4,   # 'l' (réduit de 6 à 4)
    109: 12,  # 'm' (réduit de 16 à 12)
    110: 10,  # 'n' (réduit de 13 à 10)
    116: 7,   # 't' (réduit de 10 à 7)
    119: 12,  # 'w' (réduit de 16 à 12)
}

THRESHOLD = 80                     # <----- image intensity threshold for binary conversion. It changes the contrast of the final font (default: 120)
