...
# Configuration
filename = 'PixeloidSans36'           # <----- select new font name (1.5x de PixeloidSans24)
fontname = 'PixeloidSans.ttf'         # <----- specify the font you intend to use. Place any font into the fonts folder
height = 45                           # <----- new font height (1.5x de 30)
default_width = 27                    # <----- default font width (1.5x de 18)

# Special widths for larger or thinner characters (1.5x des valeurs de PixeloidSans24)
special_widths = {
    32: 12,    # 'space' (1.5x de 8)
    39: 15,    # "'" (1.5x de 10)
    46: 14,    # '.' (1.5x de 9)
    47: 18,    # '/'
    58: 18,    # ':'
...
THRESHOLD = 60                     # <----- image intensity threshold for binary conversion. It changes the contrast of the final font (default: 120)
