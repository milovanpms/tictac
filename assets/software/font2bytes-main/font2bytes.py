...
# Configuration
filename = 'PixeloidSans22'           # <----- select new font name
fontname = 'PixeloidSans.ttf'         # <----- specify the font you intend to use
height = 26                           # <----- new font height
default_width = 14                    # <----- default font width
...
THRESHOLD = 100                    # <----- image intensity threshold for binary conversion. It changes the contrast of the final font (default: 120)
