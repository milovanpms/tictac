...
**Tictac is a connected watch prototype combining timekeeping, health tracking and NFC emulation on an STM32G4 microcontroller.**
...
- 📐 [CAO](./docs/cao.md): 3D-printed enclosure, pulse sensor jaw, dial and screen housing
