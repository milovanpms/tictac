...
#define MPU6050_RECORDING_SIZE 1200
#define MPU6050_SAMPLE_TIME 25
#define MPU6050_TEST_MODE 1
#define MPU6050_CHARGING_BARE_SIZE 30
#define MPU6050_THRESHOLD 400.0f
