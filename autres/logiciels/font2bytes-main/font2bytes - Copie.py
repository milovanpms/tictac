...
# Configuration
filename = 'PixeloidSans17'           # <----- select new font name
fontname = 'PixeloidSans.ttf'         # <----- specify the font you intend to use. Place any font into the fonts folder
height = 21                           # <----- new font height
default_width = 11                    # <----- default font width

# Special widths for larger or thinner characters
special_widths = {
    32: 7,    # 'space' (réduit de 8 à 7)
    39: 7,    # "'" (réduit de 8 à 7)
    77: 15,   # 'M' (réduit de 16 à 15)
    78: 15,   # 'N' (réduit de 16 à 15)
    87: 15,   # 'W' (réduit de 16 à 15)
    102: 8,   # 'f' (inchangé)
    105: 6,   # 'i' (inchangé)
    106: 8,   # 'j' (inchangé)
    108: 6,   # 'l' (inchangé)
    109: 15,  # 'm' (réduit de 16 à 15)
    110: 12,  # 'n' (réduit de 13 à 12)
    116: 9,   # 't' (réduit de 10 à 9)
    119: 15,  # 'w' (réduit de 16 à 15)
}

THRESHOLD = 130                     # <----- image intensity threshold for binary conversion. It changes the contrast of the final font (default: 120)
