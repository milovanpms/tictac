...
# Configuration
filename = 'PixeloidSans15'           # <----- select new font name
fontname = 'PixeloidSans.ttf'         # <----- specify the font you intend to use. Place any font into the fonts folder
height = 18                           # <----- new font height
default_width = 10                    # <----- default font width

# Special widths for larger or thinner characters
special_widths = {
    32: 6,    # 'space' (réduit de 8 à 6)
    39: 6,    # "'" (réduit de 8 à 6)
    46: 6,    # '.' (réduit de 8 à 6)
    77: 14,   # 'M' (réduit de 16 à 14)
    78: 14,   # 'N' (réduit de 16 à 14)
    87: 14,   # 'W' (réduit de 16 à 14)
    102: 7,   # 'f' (réduit de 8 à 7)
    105: 5,   # 'i' (réduit de 6 à 5)
    106: 7,   # 'j' (réduit de 8 à 7)
    108: 5,   # 'l' (réduit de 6 à 5)
    109: 14,  # 'm' (réduit de 16 à 14)
    110: 11,  # 'n' (réduit de 13 à 11)
    116: 8,   # 't' (réduit de 10 à 8)
    119: 14,  # 'w' (réduit de 16 à 14)
}

THRESHOLD = 140                     # <----- image intensity threshold for binary conversion. It changes the contrast of the final font (default: 120)
